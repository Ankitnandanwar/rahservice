...
const CompanyLogo = () => {
    ...
    const logos = [
        slack, amazon, woocommerce, meundies
    ]

    return (
        <div className='w-full container mx-auto lg:py-12 py-3 overflow-hidden flex  flex-col sm:flex-row sm:items-center items-start '>
